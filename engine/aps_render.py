# # aps_render.py - Main PDF Renderer with Black Kit (FIXED)
# """
# APS Market Intelligence - PDF Generator
# Implements APS Black Kit branding with standard 7-page layout
# FIXED: Black background with visible white/teal text
# """
...
# from aps_feed_config import detect_feed_type, get_feed_config
# from aps_black_kit import APS_COLORS, generate_aps_filename
# from aps_pages import (
#     create_page1_cover,
#     create_page2_geo_intelligence,
#     create_page3_predictive_churn,
#     create_page4_equity_insights,
#     create_page5_qa_schema,
#     create_page6_pricing_contracts,
...
#     2. Geo Intelligence → ZIP-level heatmap
#     3. Predictive Churn → Dual-model framework + narrative
#     4. Equity Insights → Risk tier segmentation
#     5. QA Schema → Field descriptions
#     6. Pricing | Contracts → Commercial info
#     7. Sample Data → Representative records
...
#     print(f"✓ Rendering standard 7-page APS Market Intelligence Report")
...
#     print("  → Rendering Page 2: Geo Intelligence (Heatmap)...")
#     create_page2_geo_intelligence(story, df)
    
#     print("  → Rendering Page 3: Predictive Churn (with Narrative)...")
#     create_page3_predictive_churn(story, df)
    
#     print("  → Rendering Page 4: Equity Insights (Risk Tiers)...")
#     create_page4_equity_insights(story, df)
    
#     print("  → Rendering Page 5: QA Schema...")
#     create_page5_qa_schema(story, df)
    
#     print("  → Rendering Page 6: Pricing | Contracts...")
#     create_page6_pricing_contracts(story)
    
#     print("  → Rendering Page 7: Sample Data...")
#     create_page7_sample_data(story, df)
...
#     print(f"✓ Header: Globe logo + 'Clean Data You Can Trust'")
#     print(f"✓ Feed Type: {feed_config['name']}")

# # Test function
# if __name__ == "__main__":
#     print("Testing APS PDF Renderer...")
...
#     output_path = Path("test_black_kit.pdf")
